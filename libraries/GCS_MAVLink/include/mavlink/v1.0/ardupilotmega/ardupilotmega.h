...
typedef enum MAV_CMD
{
	...
	MAV_CMD_NAV_WPT_WALLFOLLOW=165, /* Navigate to MISSION. |Hold time in decimal seconds. (ignored by fixed wing, time to stay at MISSION for rotary wing)| Acceptance radius in meters (if the sphere with this radius is hit, the MISSION counts as reached)| Desired distance to wall over the next leg (rotary wing)| Desired yaw angle at MISSION (rotary wing)| Latitude| Longitude| Altitude|  */
...
/** @brief  */
#ifndef HAVE_ENUM_WALLFOLLOW_STATUS_FLAGS
#define HAVE_ENUM_WALLFOLLOW_STATUS_FLAGS
typedef enum WALLFOLLOW_STATUS_FLAGS
{
	WF_OFF=0, /* The wall-follow mode has not been activated | */
	WF_ON=1, /* The wall-follow mode is active and running | */
	WF_PAUSE_RC_FAILSAFE=2, /* The wall-follow mode is paused for there is a radio failsafe | */
	WF_PAUSE_SONAR_FRONT_UNHEALTHY=4, /* The wall-follow mode is paused for the front sonar is not healthy | */
	WF_PAUSE_WALL_RNG_INVALID=8, /* Range filter considered the wall range to be invalid | */
	WALLFOLLOW_STATUS_FLAGS_ENUM_END=9, /*  | */
} WALLFOLLOW_STATUS_FLAGS;
#endif
...
#include "./mavlink_msg_wallfollow_status.h"
