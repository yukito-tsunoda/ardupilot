...
const AP_Param::Info Copter::var_info[] PROGMEM = {
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:WallFollow
    // @User: Standard
    ...
    // @Group: WALLNAV_
    // @Path: ../libraries/AC_WPNav/AC_WallNav.cpp
    GOBJECT(wall_nav, "WFNAV_",       AC_WallNav),
#endif
